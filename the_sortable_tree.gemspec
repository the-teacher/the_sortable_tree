...
Gem::Specification.new do |s|
  ...
  s.summary     = %q{Drug&Drop GUI for awesome_nested_set gem. Sortable tree view helper}
  s.description = %q{Drug&Drop GUI for awesome_nested_set gem. Sortable tree view helper}
