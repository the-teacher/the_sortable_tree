...
#       beforeSend: (xhr) ->
#         # $('.the-sortable-tree--handle').hide()

#       success: (data, status, xhr) ->
#         # $('.the-sortable-tree--handle').show()
...
#       errorClass:     'the-sortable-tree--error'
#       maxLevels:       max_levels

#       # JQ sortable optopns
#       items:            'li'
#       placeholder:      'the-sortable-tree--placeholder'
#       handle:           '.the-sortable-tree--handle'
#       # containment:      '.the-sortable-tree'
#       helper:           'clone'
#       tolerance:        'pointer'
#       revert:           250
#       opacity:          1
...
#       TheSortableTree.rebuild_sortable_tree(rebuild_url, item_id, parent_id, prev_id, next_id)
